    ...
    <div className="bg-white h-[100vh] overflow-scroll  space-y-6">
      ...
      >
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          ...
          >
            NITI BOOK empowers librarians with intelligent systems that simplify
            operations, increase access, and drive innovation in library
            management.
          </motion.p>
        </div>
      </motion.section>
      ...
      >
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            We modernize libraries through accessible, intelligent systems that
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div>
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Partnering with IRAGUHA Patrick, they built a simple PHP system
                that evolved into a comprehensive platform. Joined by IRUMVA
                Jessy Terry, the team transformed this personal solution into a
                movement empowering libraries across Rwanda.
              </p>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            education through accessible, intelligent systems that serve
