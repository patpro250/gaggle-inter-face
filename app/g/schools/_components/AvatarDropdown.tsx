        ...
        <DropdownMenu.Root>
            ...
            <DropdownMenu.Portal>
                ...
                >
                    ...
                    <DropdownMenu.Item>
                        <Link href={'/g/schools/settings'} className="flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium text-gray-700 dark:text-gray-300 transition-colors hover:bg-indigo-100 dark:hover:bg-primary">
                            <Settings size={18} />
                            Settings
                        </Link>
                    </DropdownMenu.Item>
