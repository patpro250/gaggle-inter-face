      ...
      <table className="min-w-full bg-white dark:bg-gray-800 shadow-lg rounded-2xl overflow-hidden">
        <thead className="bg-gray-100 dark:bg-gray-700">
          <tr>
            ...
            <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700 dark:text-gray-300">Fines</th>
            <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700 dark:text-gray-300">DOB</th>
            <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700 dark:text-gray-300">Status</th>
          </tr>
        </thead>
        <tbody>
          {members.map((member) => (
            <tr key={member.id} className="border-b border-gray-200 dark:border-gray-600">
              ...
              <td className="px-4 py-3 text-gray-600 dark:text-gray-300">{member.phone}</td>
              <td className="px-4 py-3 text-gray-600 dark:text-gray-300">{member.gender}</td>
              <td className="px-4 py-3 text-red-500 dark:text-red-400 font-semibold">{member.fines}</td>
              <td className="px-4 py-3 text-gray-600 dark:text-gray-300">{member.dob}</td>
              <td className="px-4 py-3">
