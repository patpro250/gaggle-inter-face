  ...
  return (
    <div className="bg-transparentfont-medium py-4 ">
      <ol className="flex items-center w-full text-3xl font-medium text-center text-gray-500 dark:text-gray-400 sm:text-base">
        ...
        <li className="flex md:w-full text-blue-600 dark:text-blue-500  items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-200 after:border-1 after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10 dark:after:border-gray-700">
