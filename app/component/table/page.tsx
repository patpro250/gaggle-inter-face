          ...
          <div className="bg-white  relative shadow-md sm:rounded-lg overflow-hidden">
            <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
              ...
              <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                <button
                  type="button"
                  className="flex items-center justify-center  text-gray-600 bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600    bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
                >
                  <svg
                ...
                <div className="flex items-center space-x-3 w-full md:w-auto">
                  <button
                    ...
                    className="w-full md:w-auto flex items-center justify-center py-2 px-4 text-sm font-medium      focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700    dark:border-gray-600     text-gray-600        "
                    type="button"
                  >
                    <svg
                  ...
                  <div
                    id="actionsDropdown"
                    className="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:     dark:divide-gray-600"
                  >
                    <ul
                    ...
                    >
                      <li>
                        <a
                          href="#"
                          className="block py-2 px-4 hover:bg-gray-100    bg-gray-600     text-gray-600"
                        >
                          Mass Edit
                        </a>
                      </li>
                    ...
                    <div className="py-1">
                      <a
                        href="#"
                        className="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100    bg-gray-600 dark:text-gray-200     text-gray-600"
                      >
                        Delete all
                      </a>
                    </div>
                  ...
                  <button
                    ...
                    className="w-full md:w-auto flex items-center justify-center py-2 px-4 text-sm font-medium text-gray-600 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700   dark:border-gray-600            "
                    type="button"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div
                    id="filterDropdown"
                    className="z-10 hidden w-48 p-3 bg-white rounded-lg shadow dark:    "
                  >
                    <h6 className="mb-3 text-sm font-medium      dark: text-gray-600">
                      Choose brand
                    </h6>
                    <ul
              ...
              <table className="w-full text-sm text-left text-gray-500   ">
                ...
                <tbody>
                  <tr className="border-b border-gray-200">
                    <th
                      scope="row"
                      className="px-4 py-3 font-medium      whitespace-nowrap dark: text-gray-600"
                    >
                      Apple iMac 27&#34;
                    </th>
                    ...
                    <td className="px-4 py-3 flex items-center justify-end">
                      <button
                        ...
                        className="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none       text-gray-100"
                        type="button"
                      >
                        <svg
                          className="w-5 h-5"
                      ...
                      >
                        ...
                        <div className="py-1">
                          <a
                            href="#"
                            className="block py-2 px-4 text-sm hover:bg-gray-100    bg-gray-600 dark:text-gray-200     text-gray-600"
                          >
                            Delete
                          </a>
                        </div>
            ...
            >
              ...
              <ul className="inline-flex items-stretch -space-x-px">
                ...
                <li>
                  <a
                    href="#"
                    className="flex items-center justify-center text-sm py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700  border-gray-200                text-gray-600"
                  >
                    1
                  </a>
                </li>
                ...
                <li>
                  <a
                    href="#"
                    aria-current="page"
                    className="flex items-center justify-center text-sm z-10 py-2 px-3 leading-tight text-primary-600 bg-primary-50 border border-primary-300 hover:bg-primary-100 hover:text-primary-700 border-gray-200 dark:     dark: text-gray-600"
                  >
                    3
                  </a>
                </li>
                ...
                <li>
                  <a
                    href="#"
                    className="flex items-center justify-center h-full py-1.5 px-3 leading-tight text-gray-500 bg-white rounded-r-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700  border-gray-200                text-gray-600"
                  >
...
export default TableLibararian;
